...
with open("/home/alexantg/test/TimeSeriesForecasting/FormattedData/logTestClean.csv", 'rt', encoding="utf_8") as f:
    mycsv = csv.reader(f)
    mycsv = list(mycsv)
    testFile = open('/home/alexantg/test/TimeSeriesForecasting/FormattedData/train.csv', 'w')
    for row in mycsv:
        if i ==0:
